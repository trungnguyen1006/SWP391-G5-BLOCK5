...
@WebServlet(name = "AddInvoiceServlet", urlPatterns = {"/sale/add-invoice"})
public class AddInvoiceServlet extends HttpServlet {

    private static final String ADD_INVOICE_PAGE = "invoice/add-invoice.jsp";
    private static final String INVOICE_LIST_URL = "invoices";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher(ADD_INVOICE_PAGE).forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (contractId > 0) {
                ...
                if (allItemsAdded) {
                    response.sendRedirect(request.getContextPath() + "/sale/" + INVOICE_LIST_URL + "?added=true");
                } else {
