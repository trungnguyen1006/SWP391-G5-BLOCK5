...
<nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
        <div class="sidebar-brand">
            <a href="${pageContext.request.contextPath}/employee/dashboard" style="font-size: 20px; font-weight: bold; color: #333;">
                CMS
            </a>
        </div>
        ...
        <ul class="sidebar-menu pt-3">
            ...
            <li><a href="${pageContext.request.contextPath}/employee/customers"><i class="uil uil-users-alt me-2 d-inline-block"></i>Customer List</a></li>
