                    ...
                    <div class="row mt-4">
                        <div class="col-lg-8">
                            <div class="card border-0 rounded shadow">
                                <div class="card-body">
                                    <form method="POST" action="${pageContext.request.contextPath}/mgr/add-warehouse">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Warehouse Code <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="warehouseCode" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="mdi mdi-check me-1"></i> Add Warehouse
                                            </button>
