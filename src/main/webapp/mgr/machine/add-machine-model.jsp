                        ...
                        <div class="col-lg-8 mt-4">
                            <div class="card border-0 rounded shadow">
                                <div class="card-body">
                                    ...
                                    <form action="${pageContext.request.contextPath}/mgr/add-machine-model" method="POST" id="addModelForm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="${pageContext.request.contextPath}/mgr/add-machine" class="btn btn-soft-primary ms-2">
