                    ...
                    <div class="d-md-flex justify-content-between">
                        ...
                        <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                ...
                                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/mgr/customers">Customers</a></li>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-8">
                            <div class="card border-0 rounded shadow">
                                <div class="card-body">
                                    <form method="POST" action="${pageContext.request.contextPath}/mgr/update-customer">
                                        <input type="hidden" name="customerId" value="${customer.customerId}">

                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Customer Code <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="customerCode" value="${customer.customerCode}" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="tel" class="form-control" name="contactPhone" value="${customer.contactPhone}">
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Contact Email</label>
                                            <input type="email" class="form-control" name="contactEmail" value="${customer.contactEmail}">
                                        </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="${pageContext.request.contextPath}/mgr/customers" class="btn btn-secondary">
