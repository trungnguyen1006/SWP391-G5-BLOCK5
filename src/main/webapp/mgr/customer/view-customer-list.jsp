        ...
        <main class="page-content bg-light">
            ...
            <div class="container-fluid">
                <div class="layout-specing">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a href="${pageContext.request.contextPath}/mgr/add-customer" class="btn btn-primary">
                                                    ...
                                                    <c:when test="${not empty customers}">
                                                        <c:forEach var="customer" items="${customers}">
                                                            <tr>
                                                                ...
                                                                <td class="p-3">${customer.customerName}</td>
                                                                <td class="p-3">
                                                                    <c:choose>
                                                                ...
                                                                <td class="p-3">
                                                                    <c:choose>
                                                                        <c:when test="${not empty customer.contactName}">
                                                                ...
                                                                <td class="p-3">
                                                                    <c:choose>
                                                                        <c:when test="${not empty customer.contactPhone}">
                                                                ...
                                                                <td class="p-3">
                                                                    <a href="${pageContext.request.contextPath}/mgr/update-customer?id=${customer.customerId}" class="btn btn-sm btn-soft-primary" title="Edit">
                                                                        <i class="mdi mdi-pencil"></i>
                                                                    </a>
                                                                    <a href="${pageContext.request.contextPath}/mgr/delete-customer?id=${customer.customerId}" class="btn btn-sm btn-soft-danger" title="Delete" onclick="return confirm('Are you sure?')">
                                            ...
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination mb-0">
                                                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/mgr/customers?page=${currentPage - 1}">Previous</a>
                                                    </li>

                                                    <c:forEach var="i" begin="1" end="${totalPages > 5 ? 5 : totalPages}">
                                                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                            <a class="page-link" href="${pageContext.request.contextPath}/mgr/customers?page=${i}">${i}</a>
                                                        </li>
                                                    </c:forEach>

                                                    <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/mgr/customers?page=${currentPage + 1}">Next</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                        </div>
