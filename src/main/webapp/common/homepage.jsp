                                ...
                                <c:choose>
                                    <c:when test="${not empty sessionScope.user.image}">
                                        <div style="position: relative; display: inline-block;">
                                            <img src="${pageContext.request.contextPath}/uploads/${sessionScope.user.image}" class="avatar avatar-ex-small rounded-circle" alt="User" onerror="this.style.display='none'; this.parentElement.querySelector('div').style.display='flex';">
                            ...
                            <div class="dropdown-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                <a class="dropdown-item d-flex align-items-center text-dark" href="#">
                                    <c:choose>
                                        <c:when test="${not empty sessionScope.user.image}">
                                            <div style="position: relative; display: inline-block;">
                                                <img src="${pageContext.request.contextPath}/uploads/${sessionScope.user.image}" class="avatar avatar-md-sm rounded-circle border shadow" alt="User" onerror="this.style.display='none'; this.parentElement.querySelector('div').style.display='flex';">
