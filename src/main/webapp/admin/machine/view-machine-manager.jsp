        ...
        <main class="page-content bg-light">
            ...
            <div class="container-fluid">
                <div class="layout-specing">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a href="${pageContext.request.contextPath}/admin/add-machine" class="btn btn-primary">
                                            ...
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination mb-0">
                                                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/machines?page=${currentPage - 1}">Previous</a>
                                                    </li>
                                                    
                                                    <c:forEach var="i" begin="1" end="${totalPages > 5 ? 5 : totalPages}">
                                                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                            <a class="page-link" href="${pageContext.request.contextPath}/admin/machines?page=${i}">${i}</a>
                                                        </li>
                                                    </c:forEach>
                                                    
                                                    <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/machines?page=${currentPage + 1}">Next</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                        </div>
