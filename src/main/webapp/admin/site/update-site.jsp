                ...
                <div class="layout-specing">
                    <div class="d-md-flex justify-content-between">
                        ...
                        <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                ...
                                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/sites">Sites</a></li>
                    ...
                    <c:if test="${site == null}">
                        <div class="alert alert-danger mt-3">
                            Site not found. <a href="${pageContext.request.contextPath}/admin/sites">Back to list</a>
                        </div>
                    </c:if>

                    <c:if test="${site != null}">
                    <form action="${pageContext.request.contextPath}/admin/update-site" method="POST" id="updateSiteForm">
                        <div class="row">
                                ...
                                <div class="card border-0 rounded shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/sites" class="btn btn-soft-primary">
                                                Cancel
                                            </a>
                                        </div>
                                    </div>
