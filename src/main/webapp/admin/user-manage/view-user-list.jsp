                  ...
                  <table class="table table-center bg-white mb-0">
                    ...
                    <c:forEach var="user" items="${userList}">
                      <tr>
                        ...
                        <td class="p-3">
                          <img src="${not empty user.image ? pageContext.request.contextPath.concat('/uploads/').concat(user.image) : pageContext.request.contextPath.concat('/assets/images/default-avatar.svg')}" class="avatar avatar-md-sm rounded-circle" alt="${user.fullName}">
                        </td>
